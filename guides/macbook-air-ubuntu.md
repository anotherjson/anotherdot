# MacBook Air repurposed as Ubuntu Linux

One-time setup notes for an old MacBook Air running Ubuntu — used as a Linux dev
box. Predates the current Arch + Hyprland setup. Kept here for reference; not
part of the active dotfiles bootstrap.
